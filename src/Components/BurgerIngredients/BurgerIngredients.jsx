...
const BurgerIngredients = ({groupedIngredients,getIngredientCountFn}) => {
    ...
    return (
        <section className={styles.BurgerIngredients}>
            ...
            <Ingredients tabInfoList={tabInfoList} getIngredientCountFn={getIngredientCountFn} groupedIngredients={groupedIngredients} activeTab={activeTab} handleSetActiveTab={setActiveTab}/>
        </section>
    );
};
