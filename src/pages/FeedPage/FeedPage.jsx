...
import {superOrderWebSocketReducerSelector} from "../../services/selectors/orderWebSocketSelectors";

const FeedPage = () => {
    const dispatch = useDispatch()
    const ingredients = useSelector(superIngredientsSelector)
    const {total,totalToday,orders} = useSelector(superOrderWebSocketReducerSelector)
    ...
    useEffect(() => {
        dispatch(webSocketOpenConnectionAction(websocketUrl.allFeedUrl))
